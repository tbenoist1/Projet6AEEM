 ...
 */
final class Version20190311121827 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE test1 (nom VARCHAR(30) NOT NULL COLLATE latin1_general_ci, prenom VARCHAR(30) NOT NULL COLLATE latin1_general_ci, age INT NOT NULL, ville VARCHAR(30) NOT NULL COLLATE latin1_general_ci, matiere VARCHAR(30) NOT NULL COLLATE latin1_general_ci, niveau VARCHAR(10) NOT NULL COLLATE latin1_general_ci, testament VARCHAR(255) NOT NULL COLLATE latin1_general_ci) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = MyISAM COMMENT = \'\' ');
